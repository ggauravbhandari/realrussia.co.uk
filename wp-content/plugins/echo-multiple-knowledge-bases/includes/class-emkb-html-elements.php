...
class EMKB_HTML_Elements {
				...
				<ul>					<?php
					...
					foreach( $args['options'] as $key => $label ) {
						...
						if( $args['current'] == $label ) {
						    $checked_list = 'emkb-radio-checked';
						}						?>
	...
	/*
		...
		@param: string $value['type']          ( Required ) How it will look ( link-error = Red  )
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="emkb-notification-box">

            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">

                <section class="emkb-header">
                    <h3><?php echo $args['header']; ?></h3>
                </section>

                <section class="emkb-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="emkb-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="emkb-body-checkboxes">
                            <ul>
                ...
                <section class="emkb-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="emkb-notification-box-cancel" class="emkb-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="emkb-notification-box-apply" class="emkb-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	/*
		...
		$values:
		@param: string $value['id']            ( Required ) Container ID, used for targeting with other JS
		@param: string $value['type']          ( Required ) How it will look ( emkb-error = Red  )
		@param: string $value['header']        ( Required ) The big Bold Main text
		@param: HTML   $value['content']       ( Required ) Any HTML P, List etc...
		@param: array  $value['checkboxes']    ( Optional ) Pass in an array of text labels.
	 */
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="emkb-notification-box emkb-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="emkb-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="emkb-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="emkb-content-toggle"><?php echo $args['toggle_text']; ?><span class="epkbfa epkbfa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="emkb-toggle-box emkb-toggle-closed">

                <section class="emkb-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="emkb-toggle-box-icon epkbfa epkbfa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="emkb-toggle-box-body">
                    <div class="emkb-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="emkb-info-box emkb-info-toggle-closed">

            <div class="emkb-info-box-icon epkbfa epkbfa-info-circle"></div>


            <div class="emkb-info-box-popup">
                <div class="emkb-info-box-container">
                    <span class="emkb-info-box-close epkbfa epkbfa-times"></span>
                    <span class="emkb-info-box-icon-max epkbfa epkbfa-expand"></span>
                    <span class="emkb-info-box-icon-min epkbfa epkbfa-compress"></span>
                    <section class="emkb-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="emkb-info-box-body">
                        <div class="emkb-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
