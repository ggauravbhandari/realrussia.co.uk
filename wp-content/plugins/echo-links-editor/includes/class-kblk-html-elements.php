...
class KBLK_HTML_Elements {
				...
				<ul>					<?php
					...
					foreach( $args['options'] as $key => $label ) {
						...
						if( $args['current'] == $label ) {
						    $checked_list = 'kblk-radio-checked';
						}						?>
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="kblk-notification-box">

            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">

                <section class="kblk-header">
                    <h3><?php echo $args['header']; ?></h3>
                </section>

                <section class="kblk-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="kblk-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="kblk-body-checkboxes">
                            <ul>
                ...
                <section class="kblk-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="kblk-notification-box-cancel" class="kblk-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="kblk-notification-box-apply" class="kblk-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	/*
		...
		$values:
		@param: string $value['id']            ( Required ) Container ID, used for targeting with other JS
		@param: string $value['type']          ( Required ) How it will look ( kblk-error = Red  )
		@param: string $value['header']        ( Required ) The big Bold Main text
		@param: HTML   $value['content']       ( Required ) Any HTML P, List etc...
		@param: array  $value['checkboxes']    ( Optional ) Pass in an array of text labels.
	 */
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="kblk-notification-box kblk-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="kblk-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="kblk-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="kblk-content-toggle"><?php echo $args['toggle_text']; ?><span class="epkbfa epkbfa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="kblk-toggle-box kblk-toggle-closed">

                <section class="kblk-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="kblk-toggle-box-icon epkbfa epkbfa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="kblk-toggle-box-body">
                    <div class="kblk-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="kblk-info-box kblk-info-toggle-closed">

            <div class="kblk-info-box-icon epkbfa epkbfa-info-circle"></div>


            <div class="kblk-info-box-popup">
                <div class="kblk-info-box-container">
                    <span class="kblk-info-box-close epkbfa epkbfa-times"></span>
                    <span class="kblk-info-box-icon-max epkbfa epkbfa-expand"></span>
                    <span class="kblk-info-box-icon-min epkbfa epkbfa-compress"></span>
                    <section class="kblk-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="kblk-info-box-body">
                        <div class="kblk-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
