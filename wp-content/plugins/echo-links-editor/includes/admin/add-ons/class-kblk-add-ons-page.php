...
class KBLK_Add_Ons_Page {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_kblk_handle_license_request', array( $this, 'user_not_logged_in' ) );
	}
	...
	public function display_license_status_update( $output ) {
		...
		$info = 'Enter your license key for the ' . KBLK_License_Handler::PLUGIN_NAME . ' add-on.';
		$output .= '<li class="ekb-add-on">';
		$output .= '<div class="ekb-add-on-title">'
					.'<h2>'. KBLK_License_Handler::PLUGIN_NAME . '</h2>' .
			            '<div class="kblk_license_info">' .
	...
	public function user_not_logged_in() {
		KBLK_Utilities::ajax_show_error_die( '<p>' . __( 'You are not logged in. Refresh your page and log in', 'echo-knowledge-base' ) . '.</p>', __( 'Cannot save your changes', 'echo-knowledge-base' ) );
	}
}