...
class ELAY_Layout_Sidebar extends ELAY_Layout {
	...
	public function get_article() {
		...
		// generate article + features content
		// TO DO if ajax $article_content = ELAY_Articles_Setup::get_article_content_and_features( $article, $article_content, array() );
	...
	*/
	private function generate_kb_main_page() {	?>
		...
		<div id="elay-sidebar-layout-page-container" class="elay-css-full-reset elay-sidebar-template">   		<?php
