...
class ELAY_Layout_Grid extends ELAY_Layout {
	...
	*/
	public function generate_kb_main_page() {
		...
		<div id="elay-grid-layout-page-container" class="elay-css-full-reset elay-grid-template <?php echo 'eckb_mp_' . $this->active_theme; ?>">
	...
	private function display_main_page_content() {
		...
		$class1 = $this->get_css_class( ' ::grid_nof_columns, eckb-categories-list' );
	...
	private function display_section( $box_category_id, $categories_icons, $category_name ) {
		...
		$body_text_style = $this->get_inline_style(	'padding-top::grid_article_list_spacing, padding-bottom::grid_article_list_spacing, typography:: grid_section_article_typography' );        ?>
				...
				<div class="elay-grid-category-title-icon-container">
					...
					if ( ! empty($category_icon['type']) && ( $this->kb_config['grid_category_icon_location'] == 'left' || $this->kb_config['grid_category_icon_location'] == 'top'  || $this->kb_config['grid_category_icon_location'] == 'right') ) {
						...
						if ( $category_icon['type'] == 'image' ) { ?>
							...
							<span class="elay-icon-elem epkbfa <?php echo esc_html( $category_icon['name'] ); ?>" <?php echo $icon_styles; ?>></span>					<?php
						}
