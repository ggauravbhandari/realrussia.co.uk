...
class ELAY_Add_Ons_Page {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_elay_handle_license_request', array( $this, 'user_not_logged_in' ) );
	}
	...
	public function display_license_status_update( $output ) {
		...
		$info = __( 'Enter your license key for the ', 'echo-knowledge-base' ) . ELAY_License_Handler::PLUGIN_NAME . __( ' add-on.', 'echo-knowledge-base' );
		$output .= '<li class="ekb-add-on">';
		$output .= '<div class="ekb-add-on-title">'
					.'<h2>'. ELAY_License_Handler::PLUGIN_NAME . '</h2>' .
			            '<div class="elay_license_info">' .
	...
	private function get_license_state( $license_handler, $license_data ) {
		...
		ELAY_Utilities::save_wp_option('elay_last_license_check', array(), true);
	...
	public function user_not_logged_in() {
		ELAY_Utilities::ajax_show_error_die( '<p>' . __( 'You are not logged in. Refresh your page and log in', 'echo-knowledge-base' ) . '.</p>', __( 'Cannot save your changes', 'echo-knowledge-base' ) );
	}
}