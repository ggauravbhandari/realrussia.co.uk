...
class ELAY_KB_Config_DB {
	...
	public function get_kb_config( $kb_id, $return_error=false ) {
		...
		if ( empty($config) || ! is_array($config) ) {
			// if new KB then this will happen: ELAY_Logging::add_log("Did not find KB configuration (DB231).", $kb_id);
		...
		// TODO add update_from_editor_config() (see Advanced Search) when editor will have separated from core page inside editor
