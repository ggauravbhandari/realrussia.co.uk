        ...
        $config_specification = array(
            ...
            'sidebar_main_page_intro_text' => array(
                ...
                'default'     => __( '
                        ...
                        <h3 style="color: red;"><strong>To edit this welcome text go to the Frontend Editor for KB Main Page.</strong></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Id eu nisl nunc mi.</p>', 'echo-elegant-layouts' )
            ),
