...
class WIDG_Recent_Articles_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title = $args['before_title'] . ( empty($title) ? esc_html__( 'Recent Articles', 'echo-widgets' ) : esc_html( $title ) ) . $args['after_title'];
        ...
        echo '<div class="widg-widget-article-container">';
        ...
        echo '</div>';//widg-widget-article-container
