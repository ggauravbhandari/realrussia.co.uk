...
class WIDG_Tags_List_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title = $args['before_title'] . ( empty($title) ? esc_html__( 'Tags', 'echo-widgets' ) : esc_html( $title ) ) . $args['after_title'];
        ...
        // DISPLAY TAGS
        echo '<div class="widg-widget-tags-container">';
        ...
        echo '</div>';// widg-widget-tags-container
