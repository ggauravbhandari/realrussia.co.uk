...
class WIDG_Categories_List_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title = $args['before_title'] . ( empty($title) ? esc_html__( 'Categories', 'echo-widgets' ) : esc_html( $title ) ) . $args['after_title'];
	    ...
	    $terms = $this->execute_search( $kb_id, $filter, $this->retrieve_category_ids( $instance ) );
	    ...
	    echo '<div class="widg-widget-categories-container">';
        ...
        echo '</div>'; //widg-widget-categories-container
    ...
    public function form( $instance ) {
	    ...
	    <p>
		    ...
		    <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'filter' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'filter' ) ); ?>" type="text" value="<?php echo $instance['filter']; ?>" />
	    </p>
