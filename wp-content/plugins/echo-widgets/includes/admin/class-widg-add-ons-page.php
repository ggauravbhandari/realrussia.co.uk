...
class WIDG_Add_Ons_Page {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_widg_handle_license_request', array( $this, 'user_not_logged_in' ) );
	}
	...
	public function display_license_status_update( $output ) {
		...
		$info = __( 'Enter your license key for the ', 'echo-knowledge-base' ) . WIDG_License_Handler::PLUGIN_NAME . __( ' add-on.', 'echo-knowledge-base' );
		$output .= '<li class="ekb-add-on">';
		$output .= '<div class="ekb-add-on-title">'
					.'<h2>'. WIDG_License_Handler::PLUGIN_NAME . '</h2>' .
			            '<div class="widg_license_info">' .
	...
	public function user_not_logged_in() {
		WIDG_Utilities::ajax_show_error_die( '<p>' . __( 'You are not logged in. Refresh your page and log in', 'echo-knowledge-base' ) . '.</p>', __( 'Cannot save your changes', 'echo-knowledge-base' ) );
	}
}