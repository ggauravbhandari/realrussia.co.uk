...
class WIDG_HTML_Elements {
				...
				<ul>					<?php
					...
					foreach( $args['options'] as $key => $label ) {
						...
						if( $args['current'] == $label ) {
						    $checked_list = 'widg-radio-checked';
						}						?>
	...
	/*
		...
		@param: string $value['type']          ( Required ) How it will look ( widg-error = Red  )
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="widg-notification-box">

            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">

                <section class="widg-header">
                    <h3><?php echo $args['header']; ?></h3>
                </section>

                <section class="widg-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="widg-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="widg-body-checkboxes">
                            <ul>
                ...
                <section class="widg-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="widg-notification-box-cancel" class="widg-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="widg-notification-box-apply" class="widg-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="widg-notification-box widg-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="widg-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="widg-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="widg-content-toggle"><?php echo $args['toggle_text']; ?><span class="fa fa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="widg-toggle-box widg-toggle-closed">

                <section class="widg-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="widg-toggle-box-icon fa fa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="widg-toggle-box-body">
                    <div class="widg-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="widg-info-box widg-info-toggle-closed">

            <div class="widg-info-box-icon fa fa-info-circle"></div>


            <div class="widg-info-box-popup">
                <div class="widg-info-box-container">
                    <span class="widg-info-box-close fa fa-times"></span>
                    <span class="widg-info-box-icon-max fa fa-expand"></span>
                    <span class="widg-info-box-icon-min fa fa-compress"></span>
                    <section class="widg-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="widg-info-box-body">
                        <div class="widg-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
