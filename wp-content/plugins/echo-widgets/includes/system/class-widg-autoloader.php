	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				'widg_html_elements'                =>  'includes/class-widg-html-elements.php',
				...
				'widg_add_ons_page'                 =>  'includes/admin/class-widg-add-ons-page.php',
				'widg_settings_page'                =>  'includes/admin/settings/class-widg-settings-page.php',
				...
				'widg_kb_config_elements'           =>  'includes/admin/kb-configuration/class-widg-kb-config-elements.php',
                'widg_kb_config_page'               =>  'includes/admin/kb-configuration/class-widg-kb-config-page.php',
				
				// WIZARD
				'widg_kb_wizard'                    =>  'includes/admin/wizard/class-widg-kb-wizard.php',
				'widg_kb_wizard_features'           =>  'includes/admin/wizard/class-widg-kb-wizard-features.php',
