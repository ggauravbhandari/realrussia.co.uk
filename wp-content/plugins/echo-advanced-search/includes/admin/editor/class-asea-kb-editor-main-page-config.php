	...
	private static function search_box_zone() {
		...
		$settings = [
			...
			'advanced_search_presets' => [
				...
				'type' => 'preset',
				'default' => 'current',
				'label' => __( 'Pre-mad Designs', 'echo-advanced-search' ),
		...
		return [
			'search_box_zone' => [
				...
				'settings'  => $settings,
				'disabled_settings' => [
					'advanced_search_mp_box_visibility' => 'asea-visibility-search-form-2'
				],
	...
	private static function search_input_zone() {
		...
		$settings = [
			...
			'advanced_search_mp_filter_header'          => [
				'editor_tab' => self::EDITOR_TAB_CONTENT,
				'type' => 'header',
				'content' => __( 'Search Filter', 'echo-advanced-search'),
			],
