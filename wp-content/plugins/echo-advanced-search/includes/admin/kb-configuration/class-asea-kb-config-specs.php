...
class ASEA_KB_Config_Specs {
	...
	public static function get_fields_specification() {
		...
		$default_style = array(
				...
				//Setup Settings ------------------------------------------/
				'advanced_search_box_visibility'                        =>  'asea-visibility-search-form-1',
	...
	private static function get_main_page_fields_specification( $default_color, $default_style ) {
		$config_specification = array(
			...
			'advanced_search_mp_box_visibility' => array(
				'label'       => __( 'Layout', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_box_visibility',
				'type'        => ASEA_Input_Filter::SELECTION,
				'options'     => array(
					'asea-visibility-search-form-1' => __( 'Search Box is visible' ),
					'asea-visibility-search-form-2' => __( 'Search Box is hidden' ),
					'asea-visibility-search-form-3' => __( 'Search Box is hidden with toggle to show it' )
				),
				'default'     => $default_style['advanced_search_box_visibility']
			),
			...
			'advanced_search_mp_filter_toggle'                              => array(
				'label'       => __( 'Search Filter', 'echo-advanced-search' ),
	...
	private static function get_article_page_fields_specification( $default_color, $default_style ) {
		$config_specification = array(
			...
			'advanced_search_ap_box_visibility' => array(
				'label'       => __( 'Layout', 'echo-advanced-search' ),
