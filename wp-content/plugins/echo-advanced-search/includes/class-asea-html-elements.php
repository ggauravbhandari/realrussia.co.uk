...
class ASEA_HTML_Elements {
	...
	public function checkbox_toggle( $args = array() ) {
		...
		<div <?php echo $id; ?> class="asea-settings-control-container asea-settings-control-type-toggle <?php echo 'asea-settings-control-type-toggle--'.$textLoc; ?>" data-field="<?php echo $data; ?>">
			<div class="asea-settings-control__field">
				<label class="asea-settings-control__title"><?php echo __( $text, 'echo-knowledge-base' ); ?></label>
				<div class="asea-settings-control__input">
					<label class="asea-settings-control-toggle">
						<input type="checkbox" class="asea-settings-control__input__toggle" value="on" name="<?php echo $id; ?>" <?php echo $checked ? 'checked' : '' ?>>
						<span class="asea-settings-control__input__label" data-on="Yes" data-off="No"></span>
						<span class="asea-settings-control__input__handle"></span>
					</label>
				</div>
			</div>
			<?php if( isset( $descText ) ){ ?>
			<div class="asea-settings-control__description"><a href="<?php echo $descURL; ?>" target="_blank"><?php echo $descText; ?></a></div>
			<?php } ?>
	...
	public function reveal_setting( $args, $input ) {
		$defaults = array(
			'id'            => '',
			'label'         => '',
			'value'          => '',
			'ViewURL'       => null,
			'submit_text'   => null,
			'submit_class'  => 'epkb-primary-btn',
		);

		$args = $this->add_defaults( $args, $defaults );		?>

		<div id="<?php echo $args['id']; ?>" class="epkb-toggle-setting-container">

			<div class="epkb-ts__header-container">
				<div class="epkb__header__label"><?php echo $args['label']; ?>:</div>
				<div class="epkb__header__value"><?php echo $args['value']; ?></div>
				<div class="epkb__header__edit">Edit</div>				<?php 
				if ( isset( $args['ViewURL']) ) { ?>
					<div class="epkb__header__view"><a href="<?php echo $args['ViewURL']; ?>">View</a></div>				<?php 
				} 		?>
			</div>

			<div class="epkb-ts__input-container">
				<?php echo $input; ?>
			</div>

			<?php
			if ( isset( $args['submit_text']) ) { ?>
				<div class="epkb-ts__action-container">
					<input value="<?php echo $args['submit_text']; ?>" type="submit" class="epkb-ts__action__submit <?php echo $args['submit_class']; ?>">
				</div>
			<?php } ?>
