...
class EPRF_KB_Config_Controller {
	...
	public function __construct() {
		add_filter( EPRF_KB_Core::EPRF_KB_CONFIG_GET_ADD_ON_INPUT, array( $this, 'get_changed_input' ), 10, 3 );
		add_filter( EPRF_KB_Core::EPRF_KB_ADD_ON_CONFIG_SPECS, array( $this, 'get_add_on_config_specs' ), 10, 1 );
		add_filter( EPRF_KB_Core::EPRF_KB_CONFIG_SAVE_INPUT, array( $this, 'save_kb_config_changes_in_db' ), 10, 4 );
