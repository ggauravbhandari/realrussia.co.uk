...
class EPRF_Add_Ons_Page {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_eprf_handle_license_request', array( $this, 'user_not_logged_in' ) );
	}
	...
	public function display_license_status_update( $output ) {
		...
		$info = __( 'Enter your license key for the ', 'echo-knowledge-base' ) . EPRF_License_Handler::PLUGIN_NAME . __( ' add-on.', 'echo-knowledge-base' );
		$output .= '<li class="ekb-add-on">';
		$output .= '<div class="ekb-add-on-title">'
					.'<h2>'. EPRF_License_Handler::PLUGIN_NAME . '</h2>' .
			            '<div class="eprf_license_info">' .
		...
		<div class="ekb-license-key">
			<ul>
				...
				<li><span class="eprf_license_action"><input id="eprf_save_btn" class="primary-btn" type="button" name="eprf_save_btn" value="<?php echo  __( 'Save', 'echo-knowledge-base' ); ?>"/>
						<input type="hidden" id="_wpnonce_eprf_license_key" name="_wpnonce_eprf_license_key" value="<?php echo wp_create_nonce( "_wpnonce_eprf_license_key" ); ?>"/></span></li>
			</ul>
		</div>
	...
	public function user_not_logged_in() {
		EPRF_Utilities::ajax_show_error_die( '<p>' . __( 'You are not logged in. Refresh your page and log in', 'echo-knowledge-base' ) . '.</p>', __( 'Cannot save your changes', 'echo-knowledge-base' ) );
	}
}