...
class EPRF_Admin_Notices {
	...
	public function show_admin_notices() {
		...
		echo  EPRF_Utilities::get_bottom_notice_message_box( $message, '', $class );
	}
	...
	function dismiss_admin_notices() {
		...
		if ( empty( $_GET['eprf_dismiss_notice_nonce'] ) || ! wp_verify_nonce( $_GET['eprf_dismiss_notice_nonce'], 'eprf_dismiss_notice') ) {
