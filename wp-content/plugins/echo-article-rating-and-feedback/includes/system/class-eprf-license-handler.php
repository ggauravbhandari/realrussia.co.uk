...
class EPRF_License_Handler {
	...
	public function get_license_status_short( $output ) {
		...
		$licenses_tab_url = admin_url('edit.php?post_type=' . EPRF_KB_Handler::get_post_type( EPRF_KB_Core::DEFAULT_KB_ID ) . '&page=ep'.'kb-add-ons#licenses');
		$output_status = array();
	...
	public function handle_license_command() {
		...
		if ( ! isset( $_REQUEST['_wpnonce_eprf_license_key'] ) || ! wp_verify_nonce( $_REQUEST['_wpnonce_eprf_license_key'], '_wpnonce_eprf_license_key' ) ) {
