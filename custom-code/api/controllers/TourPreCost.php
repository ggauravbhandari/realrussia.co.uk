    ...
    if(!empty($this->tourId)){
      ...
      if(count($this->availDepartureDate) > 0){
            ...
            */
            ...
            while ($rowA12 = $resultA12->fetch_assoc()) {
              ...
              */
              ...
              if(empty($sqlA13Result)){
                echo $sqlA13;die;
              }

              if($sqlA13Result->num_rows > 0){
        ...
        if(count($this->allDiffCostArray)==0){
          ...
          return json_encode(array('status'=>0,'data'=>[],'prefix'=>$currencyPrefix));
      ...
      return json_encode(array('status'=>1,'data'=>[]));
